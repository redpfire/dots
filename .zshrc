...
alias gbls='git for-each-ref --sort=committerdate --format="%(committerdate) %09 %(authorname) %09 %(refname)" refs/remotes | sort -r'
...
alias ns='nix-shell'
if [ -e /home/pszczurkowski/.nix-profile/etc/profile.d/nix.sh ]; then . /home/pszczurkowski/.nix-profile/etc/profile.d/nix.sh; fi # added by Nix installer
